...
START_POSES = {
    1: {  # slot 1 (Simulation Start)
        0: (-2015.5, +1823.5, 0.0),
        1: (+1823.5, +2015.5, -1.5708),
        2: (+2015.5, -1823.5, 3.1416),
        3: (-1823.5, -2015.5, +1.5708),
    },
    2: {  # slot 2 (looks like I need to fix)
        0: (-1787.5, -162.5, 0.0),
        1: (-162.5, +1787.5, -1.5708),
        2: (+1787.5, +162.5, 3.1416),
        3: (+162.5, -1787.5, +1.5708),
    },
    3: {  # slot 3 (Corner Start / Diagonal Run)
        0: (-1857.5, +1857.5, -0.7854),  # top-left → ↘
        1: (+1857.5, +1857.5, -2.3562),  # top-right → ↙
        2: (+1857.5, -1857.5, +2.3562),  # bottom-right → ↖
        3: (-1857.5, -1857.5, +0.7854),  # bottom-left → ↗
    },
}
